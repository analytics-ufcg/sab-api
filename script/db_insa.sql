...
-- -----------------------------------------------------
-- Table `INSA`.`tb_reservatorio_alterado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `INSA`.`tb_reservatorio_alterado` ;

CREATE TABLE IF NOT EXISTS `INSA`.`tb_reservatorio_alterado` (
  `id_reservatorio` INT(11) NOT NULL,
  PRIMARY KEY (`id_reservatorio`),
  CONSTRAINT `fk_tb_reservatorio_mun0`
    FOREIGN KEY (`id_reservatorio`)
    REFERENCES `INSA`.`tb_reservatorio` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `INSA`.`tb_user_reservatorio` (
  ...
  CONSTRAINT `fk_tb_reservatorio_mun00`
    FOREIGN KEY (`id_reservatorio`)
    REFERENCES `INSA`.`tb_reservatorio_alterado` (`id_reservatorio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
